<template>
  <nav
    :class="
      cn(
        'w-full h-full flex-col md:flex-row py-24  items-start -top-full fixed md:top-6 left-0 right-0 z-50 md:container mx-auto md:py-6 px-8 flex md:h-auto md:justify-between md:items-center md:rounded-2xl transition-all md:duration-300 duration-500',
  ...
  >
    ...
    >
      ...
      <NuxtLink class="font-medium text-4xl md:text-base" to="/bookmarks">
        Zapisane
      </NuxtLink>
    </div>
